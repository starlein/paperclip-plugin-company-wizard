...
- AI wizard hardening — selectable Anthropic (`claude-opus-5`, adaptive thinking, max effort) or OpenAI (`gpt-5.6-sol`, high reasoning), 65,536-token ceilings, background-job polling to beat the 30 s RPC timeout, domain-specific initial issues, defensive preset-role merging
