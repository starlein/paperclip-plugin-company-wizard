...
- The team respects company-defined delivery capacity. If `docs/lean-delivery.md` exists, apply its one-issue/two-PR WIP limits; otherwise no lean cap is implied. New work is assigned only when owner and review capacity are free.
