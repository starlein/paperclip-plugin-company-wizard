...
- New `templatesRepoUrl` plugin setting — GitHub tree URL for auto-downloading templates. Defaults to the paperclipper repo
...
This plugin is derived from [`@yesterday-ai/paperclipper`](https://github.com/Yesterday-AI/paperclipper), the standalone Clipper CLI. See that project's changelog for history prior to this plugin.
