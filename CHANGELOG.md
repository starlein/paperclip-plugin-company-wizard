...
- Lean delivery is now an optional setup module, unselected by built-in presets. Selecting it adds the company-wide contract, one Code Reviewer merge gate, and one-issue/two-PR WIP limits; standard PR review retains role-based stages and company-defined capacity when it is off.
